 ...
 */
public class CircleNewsBL implements CircleNewsBLService{
    ...
    public ArrayList<AcademicVO> getAllItems(String language) {
        ...
        EssayDao essayDao=new EssayDaoImpl();
        List<Essay> essays=essayDao.find(Type.CircleNews,Language.valueOf(language));
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
