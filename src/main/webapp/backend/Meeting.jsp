...
<div class="left_block">
    <ul>
        ...
        <li class="intent active" onclick="window.location.href='Meeting'">学术会议</li>
...
<script>
    ...
    function editItem(ele) {
        ...
        $.ajax({
            type: "get",
            async: false,
            url: "academicCommunicate/communicate/getOne",
            data: {
                "id": id
            },
            success: function (result) {
    ...
    function deleteItem(ele) {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: "academicCommunicate/communicate/delete",
            data: {
                "id": id
            },
            success: function (result) {
    ...
    function publish() {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: "academicCommunicate/communicate/update",
            data: {
                "id": id,
                "title": title,
                "author": author,
    ...
    function showForm() {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: "academicCommunicate/communicate/getID",
            success: function (result) {
                id = result;
            },
            error: function () {
