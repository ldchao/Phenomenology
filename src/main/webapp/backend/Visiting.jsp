...
<div class="left_block">
    <ul>
        ...
        <li class="intent active" onclick="window.location.href='Visiting'">师生出访</li>
...
<script>
    ...
    function editItem(ele) {
        ...
        $.ajax({
            type: "get",
            async: false,
            url: "academicCommunicate/visit/getOne",
            data: {
                "id": id
            },
            success: function (result) {
    ...
    function deleteItem(ele) {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: "academicCommunicate/visit/delete",
            data: {
                "id": id
            },
            success: function (result) {
    ...
    function publish() {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: "academicCommunicate/visit/update",
            data: {
                "id": id,
                "title": title,
                "author": author,
    ...
    function showForm() {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: "academicCommunicate/visit/getID",
            success: function (result) {
                id = result;
            },
            error: function () {
